...
#Row binding to get the final training data set
...
#Row binding to get the final testing data set
Final_test= cbind(subjects_T,activityids_T,feature_values_T)

#combining the training and testing data set
Final_Data =rbind(Final_train,Final_test)

#subsetting the data set to keep id columns, mean and standard deviation mesaurement columns
...
# merging the activity labels to the the main data set(Final_data_subset)
...
#assigning discreptive variable labels
